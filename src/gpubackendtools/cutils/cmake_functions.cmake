...
function(try_get_lapacke_with_cmake)
  ...
  if(LAPACKE_FOUND)
    ...
    set(LAPACKE_WITH_CMAKE_INCLUDE_DIR ${LAPACKE_INCLUDE_DIR} PARENT_SCOPE)
    message(CHECK_PASS "success! Found LAPACKE ${LAPACKE_VERSION}")
    message(STATUS "INSIDE2: ${LAPACKE_WITH_PKGCONFIG_INCLUDE_DIR} ${TMP_LAPACKE_WITH_PKGCONFIG_INCLUDE_DIR}")
...
function(try_get_lapacke_with_cpm)
  ...
  get_target_property(TMP_LAPACKE_WITH_PKGCONFIG_INCLUDE_DIRS lapacke INTERFACE_INCLUDE_DIRECTORIES)
  set(LAPACKE_WITH_PKGCONFIG_INCLUDE_DIRS ${TMP_LAPACKE_WITH_PKGCONFIG_INCLUDE_DIRS} PARENT_SCOPE)
  message(CHECK_PASS "done")
  message(STATUS "INSIDE3: ${LAPACKE_WITH_PKGCONFIG_INCLUDE_DIR} ${TMP_LAPACKE_WITH_PKGCONFIG_INCLUDE_DIR}")
endfunction()
...
function(get_lapacke)
  ...
  if(pkgconfig_strategy_enabled)
    ...
    if(LAPACKE_WITH_PKGCONFIG_SUCCESS)
      ...
      set(GBT_LAPACKE_INCLUDE_DIR "${LAPACKE_WITH_PKGCONFIG_INCLUDE_DIR}" PARENT_SCOPE)
      set(GBT_LAPACKE_GET_SUCCESS ON PARENT_SCOPE)
      set(GBT_LAPACKE_GET_STRATEGY "PKGCONFIG" PARENT_SCOPE)
      message(STATUS "INSIDE4: ${LAPACKE_WITH_PKGCONFIG_INCLUDE_DIR}")
  ...
  if(cmake_strategy_enabled)
    ...
    if(LAPACKE_WITH_CMAKE_SUCCESS)
      ...
      set(GBT_LAPACKE_INCLUDE_DIR "${LAPACKE_WITH_CMAKE_INCLUDE_DIR}" PARENT_SCOPE)
      set(GBT_LAPACKE_GET_SUCCESS ON PARENT_SCOPE)
      set(GBT_LAPACKE_GET_STRATEGY "CMAKE" PARENT_SCOPE)
      message(STATUS "INSIDE5: ${LAPACKE_WITH_CMAKE_INCLUDE_DIR}")
  ...
  if(fetch_strategy_enabled)
    ...
    if(LAPACKE_WITH_CPM_SUCCESS)
      ...
      set(GBT_LAPACKE_INCLUDE_DIR "${LAPACKE_WITH_CPM_INCLUDE_DIR}" PARENT_SCOPE)
      set(GBT_LAPACKE_GET_SUCCESS ON PARENT_SCOPE)
      set(GBT_LAPACKE_GET_STRATEGY "FETCH" PARENT_SCOPE)
      message(STATUS "INSIDE6: ${LAPACKE_WITH_CPM_INCLUDE_DIR}")
