...
@dataclasses.dataclass
class GPUBACKENDTOOLSBackendMethods(BackendMethods):
...
class GPUBACKENDTOOLSCpuBackend(CpuBackend, GPUBACKENDTOOLSBackend):
    """Implementation of the CPU backend"""
    
    backend_name = "gpubackendtools_backend_cpu"

    def __init__(self, *args, **kwargs):
        CpuBackend.__init__(self, *args, **kwargs)
        GPUBACKENDTOOLSBackend.__init__(self, self.cpu_methods_loader())

    @staticmethod
    def cpu_methods_loader() -> GPUBACKENDTOOLSBackendMethods:
        try:
            import gpubackendtools_backend_cpu.utils
        ...
        numpy = GPUBACKENDTOOLSCpuBackend.check_numpy()

        return GPUBACKENDTOOLSBackendMethods(
            get_ll=gpubackendtools_backend_cpu.utils.get_ll,
            fill_global=gpubackendtools_backend_cpu.utils.fill_global,
            xp=numpy,
        )
...
class GPUBACKENDTOOLSCuda11xBackend(Cuda11xBackend, GPUBACKENDTOOLSBackend):

    """Implementation of CUDA 11.x backend"""
    backend_name : str = "gpubackendtools_backend_cuda11x"

    def __init__(self, *args, **kwargs):
        Cuda11xBackend.__init__(self, *args, **kwargs)
        GPUBACKENDTOOLSBackend.__init__(self, self.cuda11x_module_loader())
        
    @staticmethod
    def cuda11x_module_loader():
        try:
            import gpubackendtools_backend_cuda11x.utils
        ...
        return GPUBACKENDTOOLSBackendMethods(
            get_ll=gpubackendtools_backend_cuda11x.utils.get_ll,
            fill_global=gpubackendtools_backend_cuda11x.utils.fill_global,
            xp=cupy,
        )
...
class GPUBACKENDTOOLSCuda12xBackend(Cuda12xBackend, GPUBACKENDTOOLSBackend):
    """Implementation of CUDA 12.x backend"""
    backend_name : str = "gpubackendtools_backend_cuda12x"
    
    def __init__(self, *args, **kwargs):
        Cuda12xBackend.__init__(self, *args, **kwargs)
        GPUBACKENDTOOLSBackend.__init__(self, self.cuda12x_module_loader())
        
    @staticmethod
    def cuda12x_module_loader():
        try:
            import gpubackendtools_backend_cuda12x.utils
        ...
        return GPUBACKENDTOOLSBackendMethods(
            get_ll=gpubackendtools_backend_cuda12x.utils.get_ll,
            fill_global=gpubackendtools_backend_cuda12x.utils.fill_global,
            xp=cupy,
        )


KNOWN_BACKENDS = {
    "cuda12x": GPUBACKENDTOOLSCuda12xBackend,
    "cuda11x": GPUBACKENDTOOLSCuda11xBackend,
    "cpu": GPUBACKENDTOOLSCpuBackend,
}
